...
(let ((class '((class color) (min-colors 89)))
      ...
      (mail-header-name '(:weight normal :foreground "#A3A3A2" :inherit variable-pitch))
      (mail-header-other '(:slant normal :foreground "grey40" :inherit variable-pitch))
      (mail-read '(:foreground "DarkGrey"))
      (mail-read-high '(:foreground "#808080"))
      (mail-ticked '(:foreground "#E92415"))
      (mail-to '(:underline nil :foreground "#006DAF" :inherit variable-pitch))
      ...
      (subject '(:weight bold :foreground "black" :inherit variable-pitch))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-header-from ((,class (:foreground "black" :inherit variable-pitch))))
   `(gnus-header-name ((,class ,mail-header-name)))
   `(gnus-header-newsgroups ((,class (:foreground "#3399CC" :inherit variable-pitch))))
   ...
   `(gnus-server-opened ((,class (:foreground "white" :foreground "#466BD7" :inherit variable-pitch))))
   ...
   `(message-separator ((,class (:weight normal :foreground "#BDC2C6" :inherit variable-pitch))))
   `(message-header-newsgroups ((,class (:foreground "#3399CC" :inherit variable-pitch))))
   ...
   `(custom-face-tag ((,class (:height 1.2 :weight bold :inherit variable-pitch))))
   `(custom-group-tag ((,class (:height 1.2 :weight bold :foreground "blue"))))
   `(custom-group-tag-1 ((,class (:height 1.2 :weight bold :foreground "red" :inherit variable-pitch))))
   ...
   `(custom-variable-tag ((,class (:height 1.2 :weight bold :foreground "blue" :inherit variable-pitch))))
   ...
   `(font-latex-sectioning-1-face ((,class (:height 2.7 :weight bold :foreground "CornflowerBlue" :inherit variable-pitch))))
   ...
   `(helm-source-header ((,class (:height 1.3 :weight bold :foreground "white" :background "#2F69BF" :inherit variable-pitch))))
   ...
   `(info-file ((,class (:height 1.8 :weight bold :box (:line-width 1 :color "#0000CC") :foreground "CornflowerBlue" :background "LightSteelBlue1" :inherit variable-pitch))))
   `(info-header-node ((,class (:underline t :foreground "orange")))) ; nodes in header
   `(info-header-xref ((,class (:underline t :foreground "DodgerBlue")))) ; cross references in header
   ...
   `(magit-section-title ((,class (:height 1.8 :weight bold :foreground "CornflowerBlue" :inherit variable-pitch))))
   ...
   `(org-document-title ((,class (:height 1.8 :weight bold :foreground "black" :inherit variable-pitch))))
   ...
   `(org-table ((,class (:foreground "DarkGreen" :background "#EAFFEA"))))
